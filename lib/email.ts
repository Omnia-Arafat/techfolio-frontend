  ...
  const html = `
    <div style="font-family:sans-serif;max-width:560px;margin:0 auto;padding:32px 24px;background:#0a0414;color:#e2e8f0;border-radius:16px">
      ...
      <p style="color:rgba(226,232,240,0.75);font-size:14px;line-height:1.6;margin:0 0 16px">
        You accepted the ${requestType} from <strong style="color:#e2e8f0">${data.applicantName}</strong> for <strong style="color:#e2e8f0">${data.positionTitle}</strong>.
      </p>
...
export async function sendApplicationRejected(data: ApplicationEmailData) {
  ...
  const html = `
    <div style="font-family:sans-serif;max-width:560px;margin:0 auto;padding:32px 24px;background:#0a0414;color:#e2e8f0;border-radius:16px">
      ...
      <p style="color:rgba(226,232,240,0.75);font-size:14px;line-height:1.6;margin:0 0 16px">
        You declined the ${requestType} from <strong style="color:#e2e8f0">${data.applicantName}</strong> for <strong style="color:#e2e8f0">${data.positionTitle}</strong>.
      </p>
